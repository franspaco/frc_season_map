...
class FRCGeocoder:
    ...
    def __init__(self, gmaps_api_key: str, archive_path: str, teams: LocationDict, events: LocationDict) -> None:
    ...
    def __read_archive(self):
        files = [f for f in os.listdir(
            self.archive_path) if os.path.isfile(os.path.join(self.archive_path, f))]
        years = {}
        for file in files:
